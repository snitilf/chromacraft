...
export const AIInput: React.FC<AIInputProps> = ({ onPaletteGenerated }) => {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative flex items-center bg-white rounded-xl shadow-sm p-1">
        ...
        <input
          ...
          className="flex-1 p-3 bg-transparent border-none outline-none text-slate-700 placeholder-slate-400 text-sm"
          disabled={loading}
        />
        <button
