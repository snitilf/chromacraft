  ...
  return (
    ...
    >
      <div className="space-y-4">
        <h4 className="text-xs font-bold uppercase tracking-wider opacity-40 mb-4" style={{ color: palette.primary }}>Buttons</h4>
      ...
      <div className="space-y-4">
        <h4 className="text-xs font-bold uppercase tracking-wider opacity-40 mb-4" style={{ color: palette.primary }}>Inputs & Controls</h4>
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-lg border border-transparent" style={{ backgroundColor: palette.surface }}>
                <span className="text-sm font-medium" style={{ color: palette.primary }}>Notifications</span>
      ...
      <div className="space-y-4">
         <h4 className="text-xs font-bold uppercase tracking-wider opacity-40 mb-4" style={{ color: palette.primary }}>Alerts</h4>
